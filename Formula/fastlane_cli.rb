...
class FastlaneCli < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/bthnkucuk/fastlane_cli/releases/download/v0.4.6/fastlane_cli-macos-arm64.tar.gz"
      sha256 "11bee603a7220fa2a6c4741e4c52245924597697c09786b8b60befa71678e521"
    end
  end
