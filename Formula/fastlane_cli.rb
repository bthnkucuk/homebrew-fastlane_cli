...
class FastlaneCli < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/bthnkucuk/fastlane_cli/releases/download/v0.4.4/fastlane_cli-macos-arm64.tar.gz"
      sha256 "c0af28547ef0a2234a554658a5f5e93c62b92bd150102a93c2de459b4b9a2769"
    end
  end
