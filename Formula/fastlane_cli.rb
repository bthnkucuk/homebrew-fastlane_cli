...
class FastlaneCli < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/bthnkucuk/fastlane_cli/releases/download/v0.4.2/fastlane_cli-macos-arm64.tar.gz"
      sha256 "4e8ef88d657d4fde9c08aeea62f7f6e755b5b189803e9e23311872ec8ac58342"
    end
  end
