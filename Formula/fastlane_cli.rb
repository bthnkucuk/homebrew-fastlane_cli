...
class FastlaneCli < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/bthnkucuk/fastlane_cli/releases/download/v0.3.2/fastlane_cli-macos-arm64.tar.gz"
      sha256 "75d2b030cbcbe6dea74eda27ca21e3c4ddc59179b4caafb320d3d4ccc3ad154f"
    end
  end
