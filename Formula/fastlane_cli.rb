...
class FastlaneCli < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/bthnkucuk/fastlane_cli/releases/download/v0.4.5/fastlane_cli-macos-arm64.tar.gz"
      sha256 "57985cd0a54a972bf9c51f03f7a70ff529010c6e026766bfd41c0b8788727a6b"
    end
  end
