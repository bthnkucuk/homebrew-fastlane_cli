...
class FastlaneCli < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/bthnkucuk/fastlane_cli/releases/download/v0.11.0/fastlane_cli-macos-arm64.tar.gz"
      sha256 "f1d51ce1e6c6b09c5f922a91cddde698e80e46d7080d11d8dd6cfa5bce21092d"
    end
  end
